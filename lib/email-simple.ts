...
function generateStatusUpdateEmailTemplate({
  ...
  > = {
    order_placed: {
      emoji: "📦",
      color: "#3b82f6",
      message: "We have received your order and are reviewing it.",
    },
    confirmed: {
      emoji: "✅",
      color: "#16a34a",
    ...
    returned: {
      emoji: "↩️",
      color: "#ea580c",
      message: "We have processed your return.",
    },
    canceled: {
      emoji: "❌",
      color: "#dc2626",
  ...
  return `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Order Update</title></head><body style="margin:0;padding:0;font-family:Arial,sans-serif;background:#f8f9fa;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9fa;"><tr><td align="center" style="padding:20px;"><table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;"><tr><td style="padding:30px;text-align:center;background:${config.color};color:white;"><h1 style="margin:0;font-size:24px;">KidsToys Bangladesh</h1><p style="margin:10px 0 0;font-size:16px;">${config.emoji} ${title}</p></td></tr><tr><td style="padding:30px;"><h2 style="color:#333;margin:0 0 10px;">Hello ${customerName}!</h2><p style="color:#666;margin:0 0 15px;">Order #${orderId}</p><div style="background:#f8f9fa;padding:20px;border-radius:6px;border-left:4px solid ${config.color};"><p style="margin:0;color:#333;font-size:16px;">${config.message}</p></div><div style="text-align:center;margin:30px 0;"><a href="https://kidstoysbangladesh.com/orders" style="display:inline-block;background:${config.color};color:white;padding:12px 24px;text-decoration:none;border-radius:4px;">Track Order</a></div><div style="text-align:center;margin:20px 0;"><a href="tel:+8801735547173" style="margin:5px;padding:8px 16px;background:#fff;color:${config.color};text-decoration:none;border:1px solid ${config.color};border-radius:4px;font-size:14px;">📞 Call</a><a href="mailto:kidstoysbangladesh@gmail.com" style="margin:5px;padding:8px 16px;background:${config.color};color:white;text-decoration:none;border-radius:4px;font-size:14px;">✉️ Email</a></div></td></tr><tr><td style="padding:20px;background:#343a40;color:white;text-align:center;"><p style="margin:0;font-size:14px;">KidsToys Bangladesh 🎈</p></td></tr></table></td></tr></table></body></html>`;
}
